/* src/config/rapids-config.h.  Generated from rapids-config.h.in by configure.  */
/* src/config/rapids-config.h.in.  Generated from configure.ac by autoheader.  */

#ifndef RAPID_CONFIG_H

#define RAPID_CONFIG_H
...
#define PACKAGE_BUGREPORT "https://github.com/RapidsOfficial/Rapids-2.0"

/* Define to the full name of this package. */
#define PACKAGE_NAME "Rapids Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "Rapids Core 4.0.99"
